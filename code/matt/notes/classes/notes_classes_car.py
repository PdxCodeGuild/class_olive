...
"""
your_car = Car('ford', 'focus', 'matt')
print(your_car.make)
print(your_car.model)
print(your_car.driver)
"""

name = input("What is your name: ")
make = input("Please enter your cars manufacturer: ")
...
new_owner = input("\nYou just sold the car what is the name of the person you just sold it to? ")
...
neighbors_name = input("\nYour neighbor also has a car, what is that persons name? ")
neighbors_make = input("Please enter your neighbors care manufacturer: ")
