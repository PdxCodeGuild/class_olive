...
for x in range(1000000):
    dummy_date.append(str(x *13984165 * 16651651 ))
...
# the variable list_data below is 
# a list of 17,028 strings with a value of '123456789'
# Let's loop over the list and show operation time
"""
