...
def retrieve():
    ...
    for contact in csv_workinprogress:
        ...
        if contact['name'] == name:
            print(f"""
            Name: {contact['name']}
            Favorite Fruit: {contact['favorite_fruit']}
    ...
    for contact in csv_workinprogress:
        if contact['name'] == name: 
            if choice == 'name':
                ...
                contact['favorite_fruit'] = new_value
            elif choice == 'color':
                contact['favorite_color'] = new_value
...
def list_of_all():
    ...
    for contact in csv_workinprogress:
        print(f"{counter} {contact['name']}, {contact['favorite_fruit']}, {contact['favorite_color']}\n")
        counter += 1
...
def save_to():
    ...
    for data in csv_workinprogress:
        data_to_save += f"{data['name']},{data['favorite_fruit']},{data['favorite_color']}\n"
